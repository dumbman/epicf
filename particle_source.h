...
private:
    ...
    void tube_radius_gt_zero( 
	Config &conf, Particle_source_tube_config_part &src_conf );
    void tube_axis_start_x_min_rad_ge_zero( 
	Config &conf, Particle_source_tube_config_part &src_conf );
    void tube_axis_start_x_plus_rad_le_grid_x_size( 
	Config &conf, Particle_source_tube_config_part &src_conf );
    void tube_axis_start_y_min_rad_ge_zero( 
	Config &conf, Particle_source_tube_config_part &src_conf );
    void tube_axis_start_y_plus_rad_le_grid_y_size( 
	Config &conf, Particle_source_tube_config_part &src_conf );
    void tube_axis_start_z_min_rad_ge_zero( 
	Config &conf, Particle_source_tube_config_part &src_conf );
    void tube_axis_start_z_plus_rad_le_grid_z_size( 
	Config &conf, Particle_source_tube_config_part &src_conf );
    void tube_axis_end_x_min_rad_ge_zero( 
	Config &conf, Particle_source_tube_config_part &src_conf );
    void tube_axis_end_x_plus_rad_le_grid_x_size( 
	Config &conf, Particle_source_tube_config_part &src_conf );
    void tube_axis_end_y_min_rad_ge_zero( 
	Config &conf, Particle_source_tube_config_part &src_conf );
    void tube_axis_end_y_plus_rad_le_grid_y_size( 
	Config &conf, Particle_source_tube_config_part &src_conf );
    void tube_axis_end_z_min_rad_ge_zero( 
	Config &conf, Particle_source_tube_config_part &src_conf );
    void tube_axis_end_z_plus_rad_le_grid_z_size( 
	Config &conf, Particle_source_tube_config_part &src_conf );
    // Write to file
    virtual void write_hdf5_source_parameters( hid_t current_source_group_id );
};
